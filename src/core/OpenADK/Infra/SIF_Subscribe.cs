...
public class SIF_Subscribe : SifMessagePayload
{
	...
	/// </summary>
	public SIF_Subscribe() : base ( InfraDTD.SIF_SUBSCRIBE ){}
	/// <summary>
	/// Creates an instance of a SIF_Subscribe
	/// </summary>
	///  <param name="sifVersion">The version of SIF to render this message in</param>
	///
	public SIF_Subscribe( SifVersion sifVersion ) : base( sifVersion, InfraDTD.SIF_SUBSCRIBE ){}

	/// <summary>
	/// Constructor used by the .Net Serialization formatter
	/// </summary>
	[SecurityPermission( SecurityAction.Demand, SerializationFormatter=true )] 
	protected SIF_Subscribe( SerializationInfo info, StreamingContext context ) : base( info, context ) {} 
	/// <summary>
	...
	public SIF_Header SIF_Header
	{
		get
		{
			return (SIF_Header)GetChild( InfraDTD.SIF_SUBSCRIBE_SIF_HEADER);
		}
		set
		{
			RemoveChild( InfraDTD.SIF_SUBSCRIBE_SIF_HEADER);
			if( value != null)
			{
				AddChild( InfraDTD.SIF_SUBSCRIBE_SIF_HEADER, value );
			}
		}
	}
	...
	public void RemoveSIF_Object( string ObjectName ) { 
		RemoveChild( InfraDTD.SIF_SUBSCRIBE_SIF_OBJECT, new String[] { ObjectName.ToString() } );
	}
	...
	public SIF_Object GetSIF_Object( string ObjectName ) { 
		return (SIF_Object)GetChild( InfraDTD.SIF_SUBSCRIBE_SIF_OBJECT, new string[] { ObjectName.ToString() } );
	}
	...
	{
		SetChildren( InfraDTD.SIF_SUBSCRIBE_SIF_OBJECT, items );
	}
