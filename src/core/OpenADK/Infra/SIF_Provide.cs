...
/// </remarks>
[Serializable]
public class SIF_Provide : SifMessagePayload
{
	/// <summary>
	/// Creates an instance of a SIF_Provide
	/// </summary>
	public SIF_Provide() : base ( InfraDTD.SIF_PROVIDE ){}
	/// <summary>
	/// Creates an instance of a SIF_Provide
	/// </summary>
	///  <param name="sifVersion">The version of SIF to render this message in</param>
	///
	public SIF_Provide( SifVersion sifVersion ) : base( sifVersion, InfraDTD.SIF_PROVIDE ){}

	/// <summary>
	/// Constructor used by the .Net Serialization formatter
	/// </summary>
	[SecurityPermission( SecurityAction.Demand, SerializationFormatter=true )] 
	protected SIF_Provide( SerializationInfo info, StreamingContext context ) : base( info, context ) {} 
	/// <summary>
	...
	{
		SetChildren( InfraDTD.SIF_PROVIDE_SIF_OBJECT, items );
	}
