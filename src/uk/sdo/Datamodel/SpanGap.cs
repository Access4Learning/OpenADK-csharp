...
public class SpanGap : SifElement
{
	...
	/// </summary>
	public SpanGap() : base ( DatamodelDTD.SPANGAP ){}
	...
	///
	public SpanGap( TimeElementType type, string code, string name, string value ) : base( DatamodelDTD.SPANGAP )
	{
		this.SetType( type );
		this.Code = code;
		this.Name = name;
	...
	public string Type
	{
		...
		set
		{
			SetField( DatamodelDTD.SPANGAP_TYPE, value );
		}
	}
	...
	{
		SetField( DatamodelDTD.SPANGAP_TYPE, val );
	}
	...
	public string Code
	{
		...
		set
		{
			SetFieldValue( DatamodelDTD.SPANGAP_CODE, new SifString( value ), value );
		}
	}
	...
	public string Name
	{
		...
		set
		{
			SetFieldValue( DatamodelDTD.SPANGAP_NAME, new SifString( value ), value );
		}
	}
	...
	public string Value
	{
		...
		set
		{
			SetFieldValue( DatamodelDTD.SPANGAP_VALUE, new SifString( value ), value );
		}
	}
	...
	public DateTime? StartDateTime
	{
		get
		{
			return (DateTime?) GetSifSimpleFieldValue( DatamodelDTD.SPANGAP_STARTDATETIME ) ;
		}
		set
		{
			SetFieldValue( DatamodelDTD.SPANGAP_STARTDATETIME, new SifDateTime( value ), value );
		}
	}
	...
	public DateTime? EndDateTime
	{
		get
		{
			return (DateTime?) GetSifSimpleFieldValue( DatamodelDTD.SPANGAP_ENDDATETIME ) ;
		}
		set
		{
			SetFieldValue( DatamodelDTD.SPANGAP_ENDDATETIME, new SifDateTime( value ), value );
		}
	}
