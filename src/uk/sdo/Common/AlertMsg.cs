...
/// </remarks>
[Serializable]
public class AlertMsg : SifKeyedElement
{
	/// <summary>
	/// Creates an instance of an AlertMsg
	/// </summary>
	public AlertMsg() : base ( CommonDTD.ALERTMSG ){}
	...
	protected AlertMsg( SerializationInfo info, StreamingContext context ) : base( info, context ) {} 
	/// <summary>
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { CommonDTD.ALERTMSG_TYPE }; }
	}

	/// <summary>
	/// Gets or sets the value of the <c>&lt;AlertMsg&gt;</c> element.
	/// </summary>
	/// <value> The <c>Value</c> of the content of this object.</value>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this of the content as: "Gets or sets the content value of the &amp;lt;AlertMsg&amp;gt; element"</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.0</para>
	/// </remarks>
	public string Value
	{
		...
		set
		{
			SetFieldValue( CommonDTD.ALERTMSG, new SifString( value ), value );
		}
	}
	...
	public string Type
	{
		...
		set
		{
			SetField( CommonDTD.ALERTMSG_TYPE, value );
		}
	}
