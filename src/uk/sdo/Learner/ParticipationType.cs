...
/// <summary>A ParticipationType</summary>
/// <remarks>
///
...
/// </remarks>
[Serializable]
public class ParticipationType : SifKeyedElement
{
	/// <summary>
	/// Creates an instance of a ParticipationType
	/// </summary>
	public ParticipationType() : base ( LearnerDTD.PARTICIPATIONTYPE ){}
	...
	protected ParticipationType( SerializationInfo info, StreamingContext context ) : base( info, context ) {} 
	/// <summary>
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { LearnerDTD.PARTICIPATIONTYPE }; }
	}

	/// <summary>
	/// Gets or sets the value of the <c>&lt;ParticipationType&gt;</c> element.
	/// </summary>
	...
	public string Value
	{
		get
		{ 
			return GetFieldValue( LearnerDTD.PARTICIPATIONTYPE );
		}
		set
		{
			SetField( LearnerDTD.PARTICIPATIONTYPE, value );
		}
	}
