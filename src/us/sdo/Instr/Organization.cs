...
public class Organization : SifKeyedElement
{
	...
	/// </summary>
	public Organization() : base ( InstrDTD.ORGANIZATION ){}
	...
	///
	public Organization( string value ) : base( InstrDTD.ORGANIZATION )
	{
		this.Value = value;
	}
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { InstrDTD.ORGANIZATION }; }
	}
	...
	public string Value
	{
		get
		{
			return (string) GetSifSimpleFieldValue( InstrDTD.ORGANIZATION ) ;
		}
		set
		{
			SetFieldValue( InstrDTD.ORGANIZATION, new SifString( value ), value );
		}
	}
