...
/// <summary>A BilledEntity</summary>
/// <remarks>
///
...
/// </remarks>
[Serializable]
public class BilledEntity : SifKeyedElement
{
	/// <summary>
	/// Creates an instance of a BilledEntity
	/// </summary>
	public BilledEntity() : base ( HrfinDTD.BILLEDENTITY ){}
	...
	protected BilledEntity( SerializationInfo info, StreamingContext context ) : base( info, context ) {} 
	/// <summary>
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { HrfinDTD.BILLEDENTITY_SIF_REFOBJECT }; }
	}
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this of the content as: "Gets or sets the content value of the &amp;lt;BilledEntity&amp;gt; element"</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.0</para>
	/// </remarks>
	public string Value
	{
		get
		{
			return (string) GetSifSimpleFieldValue( HrfinDTD.BILLEDENTITY ) ;
		}
		set
		{
			SetFieldValue( HrfinDTD.BILLEDENTITY, new SifString( value ), value );
		}
	}
	...
	public string SIF_RefObject
	{
		get
		{ 
			return GetFieldValue( HrfinDTD.BILLEDENTITY_SIF_REFOBJECT );
		}
		set
		{
			SetField( HrfinDTD.BILLEDENTITY_SIF_REFOBJECT, value );
		}
	}
