...
public class AnnualItem : SifElement
{
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;AccountTypeDetail&gt;</c> element.
	/// </summary>
	/// <value> The <c>AccountTypeDetail</c> element of this object.</value>
	/// <remarks>
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;FundClassificationCode&gt;</c> element.
	/// </summary>
	/// <value> The <c>FundClassificationCode</c> element of this object.</value>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "A fund is a separate fiscal and accounting entity with a self-balancing set of accounts recording cash and other financial resources, together with all related liabilities and residual equities or balances, or changes therein, e.g. the code for Debt Service Funds, or Capital Projects Funds, or Pension Funds, to name a few examples."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	public string FundClassificationCode
	{
		get
		{
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "An identifier for the level of instruction provided by the facility or operational unit e.g. Middle, Elementary, Prekindergarten, Charter This has greater granularity than the SIF element ExpenditureArea."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;OperationalUnit&gt;</c> element.
	/// </summary>
	/// <value> The <c>OperationalUnit</c> element of this object.</value>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "The code for a location, building, organization code, facility or site. For example, this code can identify a Charter School or Maintenance Facility."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;ProjectCode&gt;</c> element.
	/// </summary>
	/// <value> The <c>ProjectCode</c> element of this object.</value>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "A code used for project reporting. For instance, according to NCES, this code can be parsed to identify the particular funding source, authority, or expenditure purpose for which a special record or report is required, and to identify particular projects and the fiscal year of the appropriation within that funding source."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "Codes used for recording revenue and other receivables by source, e.g. codes for Taxes Levied/Assessed by the School District, Sales and Use Taxes, code for Textbook Sales and Rentals, etc."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;ChartOfAccountCode&gt;</c> element.
	/// </summary>
	/// <value> The <c>ChartOfAccountCode</c> element of this object.</value>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "Balance Sheet account number used for an Asset, Liability, or Equity (equity also known as Net Asset or Fund Balance), e.g. a code for Cash in Bank, or Interfund Loans Payable, or Unreserved Fund Balance, etc."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;SubjectMatter&gt;</c> element.
	/// </summary>
	/// <value> The <c>SubjectMatter</c> element of this object.</value>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "The actual code that identifies the organization of subject matter and related learning experiences provided for the instruction of students."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
