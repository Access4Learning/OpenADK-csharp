...
public class SIF_Metadata : SifElement
{
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;EducationFilter&gt;</c> element.
	/// </summary>
	/// <value> An EducationFilter </value>
	/// <remarks>
	/// <para>To remove the <c>EducationFilter</c>, set <c>EducationFilter</c> to <c>null</c></para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.1</para>
	/// </remarks>
	public EducationFilter EducationFilter
	{
		get
		{
