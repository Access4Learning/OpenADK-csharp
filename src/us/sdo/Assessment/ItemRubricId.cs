...
public class ItemRubricId : SifKeyedElement
{
	...
	/// </summary>
	public ItemRubricId() : base ( AssessmentDTD.ITEMRUBRICID ){}
	...
	///
	public ItemRubricId( string value ) : base( AssessmentDTD.ITEMRUBRICID )
	{
		this.Value = value;
	}
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { AssessmentDTD.ITEMRUBRICID }; }
	}
	...
	public string Value
	{
		get
		{
			return (string) GetSifSimpleFieldValue( AssessmentDTD.ITEMRUBRICID ) ;
		}
		set
		{
			SetFieldValue( AssessmentDTD.ITEMRUBRICID, new SifString( value ), value );
		}
	}
