...
public class ItemCharacteristics : SifDataObject
{
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "The description of the Sample the statistics are based on. May be District name, State or National sample."</para>
	/// <para>Version: 2.5</para>
	/// <para>Since: 2.5</para>
	/// </remarks>
