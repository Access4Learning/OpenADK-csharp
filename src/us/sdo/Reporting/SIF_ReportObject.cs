...
public class SIF_ReportObject : SifDataObject
{
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this null as: "Container element for the report content; one valid SIF object can occur as a child here. This element is conditional. 
	/// This element or ReportInfo or SIF_ExtendedQueryResults is included but never at the same time. 
	/// See examples of the usage of the object below."</para>
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this null as: "The report content resulting from a SIF_ExtendedQuery-based report.  This element is conditional.
	/// This element or ReportInfo or ReportData is included but never at the same time. "</para>
