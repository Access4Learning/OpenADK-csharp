...
/// <summary>An AgencyReporting</summary>
/// <remarks>
///
...
/// </remarks>
[Serializable]
public class AgencyReporting : SifKeyedElement
{
	/// <summary>
	/// Creates an instance of an AgencyReporting
	/// </summary>
	public AgencyReporting() : base ( StudentDTD.AGENCYREPORTING ){}
	...
	protected AgencyReporting( SerializationInfo info, StreamingContext context ) : base( info, context ) {} 
	/// <summary>
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { StudentDTD.AGENCYREPORTING_SIF_REFOBJECT }; }
	}
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this of the content as: "Gets or sets the content value of the &amp;lt;AgencyReporting&amp;gt; element"</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.0</para>
	/// </remarks>
	public string Value
	{
		get
		{
			return (string) GetSifSimpleFieldValue( StudentDTD.AGENCYREPORTING ) ;
		}
		set
		{
			SetFieldValue( StudentDTD.AGENCYREPORTING, new SifString( value ), value );
		}
	}
	...
	public string SIF_RefObject
	{
		get
		{ 
			return GetFieldValue( StudentDTD.AGENCYREPORTING_SIF_REFOBJECT );
		}
		set
		{
			SetField( StudentDTD.AGENCYREPORTING_SIF_REFOBJECT, value );
		}
	}
