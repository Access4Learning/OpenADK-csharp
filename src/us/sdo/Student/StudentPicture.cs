...
/// <summary>A student picture.</summary>
/// <remarks>
///
...
public class StudentPicture : SifDataObject
{
	...
	///       </param>
	///
	public StudentPicture( string studentPersonalRefId, PictureSource pictureSource, int? schoolYear ) : base( Adk.SifVersion, StudentDTD.STUDENTPICTURE )
	{
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { StudentDTD.STUDENTPICTURE_STUDENTPERSONALREFID }; }
	}
