...
public class SchoolFocus : SifKeyedElement
{
	...
	/// </summary>
	public SchoolFocus() : base ( StudentDTD.SCHOOLFOCUS ){}
	...
	///
	public SchoolFocus( SchoolFocusType value ) : base( StudentDTD.SCHOOLFOCUS )
	{
		this.SetValue( value );
	}
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { StudentDTD.SCHOOLFOCUS }; }
	}
	...
	public string Value
	{
		get
		{ 
			return GetFieldValue( StudentDTD.SCHOOLFOCUS );
		}
		set
		{
			SetField( StudentDTD.SCHOOLFOCUS, value );
		}
	}
	...
	/// </summary>
	/// <param name="val">A SchoolFocusType object</param>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this of the content as: "Gets or sets the content value of the &amp;lt;SchoolFocus&amp;gt; element"</para>
	/// <para>Version: 2.5</para>
	/// <para>Since: 1.5r1</para>
	/// </remarks>
	public void SetValue( SchoolFocusType val )
	{
		SetField( StudentDTD.SCHOOLFOCUS, val );
	}
