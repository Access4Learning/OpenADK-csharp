...
/// <summary>Defines a student picture, which can either be a URL or picture data</summary>
/// <remarks>
///
...
public class PictureSource : SifKeyedElement
{
	...
	///
	public PictureSource( PictureType type, string value ) : base( CommonDTD.PICTURESOURCE )
	{
		this.SetType( type );
		this.Value = value;
	}
