...
public class ExitType : SifKeyedElement
{
	...
	/// </summary>
	public ExitType() : base ( CommonDTD.EXITTYPE ){}
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { CommonDTD.EXITTYPE_CODE }; }
	}
	...
	public string Code
	{
		get
		{ 
			return GetFieldValue( CommonDTD.EXITTYPE_CODE );
		}
		set
		{
			SetField( CommonDTD.EXITTYPE_CODE, value );
		}
	}
	...
	public OtherCodeList OtherCodeList
	{
		get
		{
			return (OtherCodeList)GetChild( CommonDTD.EXITTYPE_OTHERCODELIST);
		}
		set
		{
			RemoveChild( CommonDTD.EXITTYPE_OTHERCODELIST);
			if( value != null)
			{
				AddChild( CommonDTD.EXITTYPE_OTHERCODELIST, value );
			}
		}
	}
