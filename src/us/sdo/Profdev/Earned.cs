...
/// <summary>The number of units earned</summary>
/// <remarks>
///
...
/// </remarks>
[Serializable]
public class Earned : SifKeyedElement
{
	/// <summary>
	/// Creates an instance of an Earned
	/// </summary>
	public Earned() : base ( ProfdevDTD.EARNED ){}
	...
	///
	public Earned( EarnedType type, string value ) : base( ProfdevDTD.EARNED )
	{
		this.SetType( type );
		this.Value = value;
	}
	...
	protected Earned( SerializationInfo info, StreamingContext context ) : base( info, context ) {} 
	/// <summary>
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { ProfdevDTD.EARNED_TYPE }; }
	}
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this of the content as: "Gets or sets the content value of the &amp;lt;Earned&amp;gt; element"</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 1.5r1</para>
	/// </remarks>
	public string Value
