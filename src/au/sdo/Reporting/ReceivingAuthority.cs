...
/// <summary>A ReceivingAuthority</summary>
/// <remarks>
///
...
public class ReceivingAuthority : SifKeyedElement
{
	...
	///
	public ReceivingAuthority( ReceivingAuthoritySIF_RefObject sifRefObject, string value ) : base( ReportingDTD.RECEIVINGAUTHORITY )
	{
	...
	public string SIF_RefObject
	{
		...
		set
		{
			SetField( ReportingDTD.RECEIVINGAUTHORITY_SIF_REFOBJECT, value );
		}
	}
	...
	/// </summary>
	/// <param name="val">A ReceivingAuthoritySIF_RefObject object</param>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this attribute as: "The name of the object referenced."</para>
	/// <para>Version: 2.5</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	public void SetSIF_RefObject( ReceivingAuthoritySIF_RefObject val )
	{
		SetField( ReportingDTD.RECEIVINGAUTHORITY_SIF_REFOBJECT, val );
	}
