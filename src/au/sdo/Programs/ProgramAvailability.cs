...
public class ProgramAvailability : SifKeyedElement
{
	...
	///
	public ProgramAvailability( AUCodeSets0211ProgramAvailabilityType code ) : base( ProgramsDTD.PROGRAMAVAILABILITY )
	{
		this.SetCode( code );
	}
	...
	/// </summary>
	/// <param name="val">A AUCodeSets0211ProgramAvailabilityType object</param>
	/// <remarks>
	/// <para>Version: 2.5</para>
	/// <para>Since: 2.4</para>
	/// </remarks>
	public void SetCode( AUCodeSets0211ProgramAvailabilityType val )
	{
