...
/// </remarks>
[Serializable]
public class LanguageOfInstruction : SifKeyedElement
{
	/// <summary>
	/// Creates an instance of a LanguageOfInstruction
	/// </summary>
	public LanguageOfInstruction() : base ( SchoolDTD.LANGUAGEOFINSTRUCTION ){}
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { SchoolDTD.LANGUAGEOFINSTRUCTION_CODE }; }
	}
	...
	public string Code
	{
		get
		{ 
			return GetFieldValue( SchoolDTD.LANGUAGEOFINSTRUCTION_CODE );
		}
		set
		{
			SetField( SchoolDTD.LANGUAGEOFINSTRUCTION_CODE, value );
		}
	}
	...
	public OtherCodeList OtherCodeList
	{
		get
		{
			return (OtherCodeList)GetChild( SchoolDTD.LANGUAGEOFINSTRUCTION_OTHERCODELIST);
		}
		set
		{
			RemoveChild( SchoolDTD.LANGUAGEOFINSTRUCTION_OTHERCODELIST);
			if( value != null)
			{
				AddChild( SchoolDTD.LANGUAGEOFINSTRUCTION_OTHERCODELIST, value );
			}
		}
	}
