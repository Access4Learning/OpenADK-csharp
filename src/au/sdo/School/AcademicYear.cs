...
/// <summary>An AcademicYear</summary>
/// <remarks>
///
...
/// </remarks>
[Serializable]
public class AcademicYear : SifKeyedElement
{
	/// <summary>
	/// Creates an instance of an AcademicYear
	/// </summary>
	public AcademicYear() : base ( SchoolDTD.ACADEMICYEAR ){}
	...
	protected AcademicYear( SerializationInfo info, StreamingContext context ) : base( info, context ) {} 
	/// <summary>
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { SchoolDTD.ACADEMICYEAR_CODE }; }
	}
	...
	public string Code
	{
		get
		{ 
			return GetFieldValue( SchoolDTD.ACADEMICYEAR_CODE );
		}
		set
		{
			SetField( SchoolDTD.ACADEMICYEAR_CODE, value );
		}
	}
	...
	public OtherCodeList OtherCodeList
	{
		get
		{
			return (OtherCodeList)GetChild( SchoolDTD.ACADEMICYEAR_OTHERCODELIST);
		}
		set
		{
			RemoveChild( SchoolDTD.ACADEMICYEAR_OTHERCODELIST);
			if( value != null)
			{
				AddChild( SchoolDTD.ACADEMICYEAR_OTHERCODELIST, value );
			}
		}
	}
