...
public class AssessmentForm : SifDataObject
{
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "The RefId of the assessment related to this form."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.4</para>
	/// </remarks>
	...
	public YearLevels YearLevels
	{
		get
		{
			return (YearLevels)GetChild( AssessmentDTD.ASSESSMENTFORM_YEARLEVELS);
		}
		set
		{
			RemoveChild( AssessmentDTD.ASSESSMENTFORM_YEARLEVELS);
			if( value != null)
			{
				AddChild( AssessmentDTD.ASSESSMENTFORM_YEARLEVELS, value );
			}
		}
	}
	...
	public void SetAssessmentSubTestRefIds( AssessmentSubTestRefId AssessmentSubTestRefId ) {
		...
		AddChild( AssessmentDTD.ASSESSMENTFORM_ASSESSMENTSUBTESTREFIDS, new AssessmentSubTestRefIds( AssessmentSubTestRefId ) );
	}
