...
public class StudentSchoolEnrollment : SifDataObject
{
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;FFPOS&gt;</c> element.
	/// </summary>
	/// <value> The <c>FFPOS</c> element of this object.</value>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "Enrolled Full-fee Paying Overseas Student (FFPOS) Status. Enrolment Frame Element 10 NSCC Collection."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	public string FFPOS
	{
		get
		{ 
			return GetFieldValue( StudentDTD.STUDENTSCHOOLENROLLMENT_FFPOS );
		}
		set
		{
			SetField( StudentDTD.STUDENTSCHOOLENROLLMENT_FFPOS, value );
		}
	}

	/// <summary>
	/// Sets the value of the <c>&lt;FFPOS&gt;</c> element.
	/// </summary>
	/// <param name="val">A AUCodeSetsFFPOSStatusCodeType object</param>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "Enrolled Full-fee Paying Overseas Student (FFPOS) Status. Enrolment Frame Element 10 NSCC Collection."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	public void SetFFPOS( AUCodeSetsFFPOSStatusCodeType val )
	{
		SetField( StudentDTD.STUDENTSCHOOLENROLLMENT_FFPOS, val );
	}
...
// BEGIN EXTRA METHODS (C:/GitHub/rafidzal/OpenADK-java/adk-generator/../adk-generator/datadef/au/sif23/StudentSchoolEnrollment.txt.cs)
