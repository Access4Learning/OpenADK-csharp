...
public class StudentAttendanceSummary : SifDataObject
{
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;StudentAttendanceSummaryRefId&gt;</c> element.
	/// </summary>
	/// <value> The <c>StudentAttendanceSummaryRefId</c> element of this object.</value>
	/// <remarks>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	public string StudentAttendanceSummaryRefId
	{
		get
		{
			return (string) GetSifSimpleFieldValue( StudentDTD.STUDENTATTENDANCESUMMARY_STUDENTATTENDANCESUMMARYREFID ) ;
		}
		set
		{
			SetFieldValue( StudentDTD.STUDENTATTENDANCESUMMARY_STUDENTATTENDANCESUMMARYREFID, new SifString( value ), value );
		}
	}
