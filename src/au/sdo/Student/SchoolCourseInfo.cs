...
/// <summary>A SchoolCourseInfo</summary>
/// <remarks>
///
...
public class SchoolCourseInfo : SifDataObject
{
	...
	///
	public SchoolCourseInfo( string refId, string schoolInfoRefId, string courseCode, string courseTitle ) : base( Adk.SifVersion, StudentDTD.SCHOOLCOURSEINFO )
	{
		this.RefId = refId;
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "The ID (GUID) that identifies the school where the course is offered."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "The locally-assigned identifier for this school/campus."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	public string SchoolLocalId
	{
		get
		{
			return (string) GetSifSimpleFieldValue( StudentDTD.SCHOOLCOURSEINFO_SCHOOLLOCALID ) ;
		}
		set
		{
			SetFieldValue( StudentDTD.SCHOOLCOURSEINFO_SCHOOLLOCALID, new SifString( value ), value );
		}
	}
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "School year for which the information is applicable, expressed as the four-digit year in which the school year ends (e.g. 2007)."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "The ID (GUID) that uniquely identifies this TermInfo (reportable time period).        Either SchoolYear or TermInfoRefId must be provided."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	public string TermInfoRefId
	{
		get
		{
			return (string) GetSifSimpleFieldValue( StudentDTD.SCHOOLCOURSEINFO_TERMINFOREFID ) ;
		}
		set
		{
			SetFieldValue( StudentDTD.SCHOOLCOURSEINFO_TERMINFOREFID, new SifString( value ), value );
		}
	}
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this null as: "Subject matter areas."</para>
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "An indication of the general nature and difficulty of instruction provided."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	public string InstructionalLevel
	{
		get
		{
			return (string) GetSifSimpleFieldValue( StudentDTD.SCHOOLCOURSEINFO_INSTRUCTIONALLEVEL ) ;
		}
		set
		{
			SetFieldValue( StudentDTD.SCHOOLCOURSEINFO_INSTRUCTIONALLEVEL, new SifString( value ), value );
		}
	}
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "The number of credits awarded upon course completion."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	public string CourseCredits
	{
		get
		{
			return (string) GetSifSimpleFieldValue( StudentDTD.SCHOOLCOURSEINFO_COURSECREDITS ) ;
		}
		set
		{
			SetFieldValue( StudentDTD.SCHOOLCOURSEINFO_COURSECREDITS, new SifString( value ), value );
		}
	}
	...
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "Department with jurisdiction over this course."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;CourseContent&gt;</c> element.
	/// </summary>
	/// <value> The <c>CourseContent</c> element of this object.</value>
	/// <remarks>
	/// <para>The SIF specification defines the meaning of this element as: "Description of course content."</para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.3</para>
	/// </remarks>
	public string CourseContent
	{
		get
		{
			return (string) GetSifSimpleFieldValue( StudentDTD.SCHOOLCOURSEINFO_COURSECONTENT ) ;
		}
		set
		{
			SetFieldValue( StudentDTD.SCHOOLCOURSEINFO_COURSECONTENT, new SifString( value ), value );
		}
	}
