...
public class CalendarDate : SifDataObject
{
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;CalendarDateRefId&gt;</c> element.
	/// </summary>
	/// <value> The <c>CalendarDateRefId</c> element of this object.</value>
	/// <remarks>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	public string CalendarDateRefId
	{
		get
		{
			return (string) GetSifSimpleFieldValue( StudentDTD.CALENDARDATE_CALENDARDATEREFID ) ;
		}
		set
		{
			SetFieldValue( StudentDTD.CALENDARDATE_CALENDARDATEREFID, new SifString( value ), value );
		}
	}
