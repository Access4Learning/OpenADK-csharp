...
public class RubricIdentifier : SifKeyedElement
{
	...
	/// </summary>
	public RubricIdentifier() : base ( Sif3assessmentDTD.RUBRICIDENTIFIER ){}
	...
	///
	public RubricIdentifier( string value ) : base( Sif3assessmentDTD.RUBRICIDENTIFIER )
	{
		this.Value = value;
	}
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { Sif3assessmentDTD.RUBRICIDENTIFIER }; }
	}
	...
	public string Value
	{
		get
		{
			return (string) GetSifSimpleFieldValue( Sif3assessmentDTD.RUBRICIDENTIFIER ) ;
		}
		set
		{
			SetFieldValue( Sif3assessmentDTD.RUBRICIDENTIFIER, new SifString( value ), value );
		}
	}
	...
	public string RubricIdentifierType
	{
		get
		{ 
			return GetFieldValue( Sif3assessmentDTD.RUBRICIDENTIFIER_RUBRICIDENTIFIERTYPE );
		}
		set
		{
			SetField( Sif3assessmentDTD.RUBRICIDENTIFIER_RUBRICIDENTIFIERTYPE, value );
		}
	}
	...
	/// <para>Since: 2.6</para>
	/// </remarks>
	public void SetRubricIdentifierType( AssessmentIdType val )
	{
		SetField( Sif3assessmentDTD.RUBRICIDENTIFIER_RUBRICIDENTIFIERTYPE, val );
	}
