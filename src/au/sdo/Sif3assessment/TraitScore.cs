...
public class TraitScore : SifElement
{
	...
	public string TraitScoreType
	{
		get
		{
			return (string) GetSifSimpleFieldValue( Sif3assessmentDTD.TRAITSCORE_TRAITSCORETYPE ) ;
		}
		set
		{
			SetFieldValue( Sif3assessmentDTD.TRAITSCORE_TRAITSCORETYPE, new SifString( value ), value );
		}
	}
	...
	public string TraitScoreValue
	{
		get
		{
			return (string) GetSifSimpleFieldValue( Sif3assessmentDTD.TRAITSCORE_TRAITSCOREVALUE ) ;
		}
		set
		{
			SetFieldValue( Sif3assessmentDTD.TRAITSCORE_TRAITSCOREVALUE, new SifString( value ), value );
		}
	}
	...
	public string TraitScoreCode
	{
		get
		{
			return (string) GetSifSimpleFieldValue( Sif3assessmentDTD.TRAITSCORE_TRAITSCORECODE ) ;
		}
		set
		{
			SetFieldValue( Sif3assessmentDTD.TRAITSCORE_TRAITSCORECODE, new SifString( value ), value );
		}
	}
