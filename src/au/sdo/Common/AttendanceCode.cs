...
public class AttendanceCode : SifKeyedElement
{
	...
	public override IElementDef[] KeyFields {
		get { return new IElementDef[] { CommonDTD.ATTENDANCECODE_CODE }; }
	}
	...
	public string Code
	{
		get
		{ 
			return GetFieldValue( CommonDTD.ATTENDANCECODE_CODE );
		}
		set
		{
			SetField( CommonDTD.ATTENDANCECODE_CODE, value );
		}
	}
	...
	public OtherCodeList OtherCodeList
	{
		get
		{
			return (OtherCodeList)GetChild( CommonDTD.ATTENDANCECODE_OTHERCODELIST);
		}
		set
		{
			RemoveChild( CommonDTD.ATTENDANCECODE_OTHERCODELIST);
			if( value != null)
			{
				AddChild( CommonDTD.ATTENDANCECODE_OTHERCODELIST, value );
			}
		}
	}
