...
public class Address : SifElement
{
	...
	/// <summary>
	/// Gets or sets the value of the <c>&lt;StatisticalAreas&gt;</c> element.
	/// </summary>
	/// <value> A StatisticalAreaList </value>
	/// <remarks>
	/// <para>To remove the <c>StatisticalAreaList</c>, set <c>StatisticalAreas</c> to <c>null</c></para>
	/// <para>Version: 2.6</para>
	/// <para>Since: 2.6</para>
	/// </remarks>
	public StatisticalAreaList StatisticalAreas
	{
		get
		{
			return (StatisticalAreaList)GetChild( CommonDTD.ADDRESS_STATISTICALAREAS);
		}
		set
		{
			RemoveChild( CommonDTD.ADDRESS_STATISTICALAREAS);
			if( value != null)
			{
				AddChild( CommonDTD.ADDRESS_STATISTICALAREAS, value );
			}
		}
	}
